...
public class ImageAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    @NonNull
    @Override
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup paren, int viewType) {

        context = paren.getContext();
        View view = LayoutInflater.from(context).inflate(R.layout.item_view, paren, false);
